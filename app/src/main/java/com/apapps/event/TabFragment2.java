...
import static com.apapps.event.R.id.TabFragment2;
import static com.apapps.event.R.id.container;
...
public class TabFragment2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root =  inflater.inflate(R.layout.activity_tab_fragment2, container, false);
        ...
        adapter = new EventAdapter(getContext(),eventList, false);
    ...
    private void readEvents(){
        ...
        dbInstance.orderByChild("eventDate").endAt(currentDate).addListenerForSingleValueEvent(eventListener);
